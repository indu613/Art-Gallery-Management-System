...
<head>
    ...
    <style>
        *{
        ...
        body {
            background: linear-gradient(to right, #ff6d6d, #bc0013); /* You can replace these colors with your desired gradient */
        ...
        .wrapper {
            ...
            margin: 50px auto;
            padding: 20px;
            background: linear-gradient(to right, rgb(108, 0, 0), rgb(226, 89, 89));
        ...
        .inputbox,.medium,.genre,.price,.image {
            margin-bottom: 20px;
        }
        label {
            display: block;
        ...
        button {
            ...
            border-radius: 4px;
            cursor: pointer;
            background-color: rgb(98, 0, 20);
            color: #fff;
        }

        button:hover {
            background-color: #ab0000; /* Change the color to your desired hover color */
        }
...
<body>
    <div class="wrapper">
        <form id="myForm" method="post" action="artUpdateAdmSubmit.php" enctype="multipart/form-data" onsubmit="return confirmUpdate()">
            <h1>Update Price</h1>
            <div class="inputbox">
