...
if (isset($_POST['logout'])) {
    session_unset();
    session_destroy();
    echo "<script>window.location='home.html';alert('You are Logged Out!'); </script>";
    exit;
}
?>
...
<head>
    ...
    <style>
        ...
        .logout-button {
            background-color: rgb(214, 99, 151);
            color: white;
        }
        ...
        .home-button:hover {
            background-color: rgb(70, 91, 165);
        }
    </style>
</head>
<body>
...
$sql = "SELECT * FROM user WHERE userid = $custid";
   ...
   ?>
    ...
    <div id="button-container">
        <form method="post">
            ...
            <button class="button home-button"><a href="home.php">Home</a></button>
        </form>
    </div>
</body>
</html>
